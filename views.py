...
from state import registrar_final, carregar_conquistas
...
def imprimir_tutorial(ui):
    ...
    ui.exibir(f"{DOS_BRANCO}2. Interaja com objetos digitando {DOS_VERDE}pegar [item]{DOS_BRANCO} ou {DOS_VERDE}examinar [item]{DOS_BRANCO}.{RESET}")
    ui.exibir(f"{DOS_BRANCO}3. Você pode encurtar comandos usando {DOS_VERDE}p chave{DOS_BRANCO} em vez de {DOS_VERDE}pegar chave{DOS_BRANCO}.{RESET}")
